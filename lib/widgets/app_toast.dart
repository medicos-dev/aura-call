...
class _DynamicIslandToastState extends State<_DynamicIslandToast>
  ...
  void _initControllers() {
    ...
    _slideAnimation = Tween<double>(begin: -150.0, end: 20.0).animate(
        ...
        child: SafeArea(
          child: Align(
            ...
            child: AnimatedBuilder(
              animation: Listenable.merge([_slideAnimation!, _expandAnimation!, _fadeAnimation!]),
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: widget.accentColor.withValues(alpha: 0.2 * fadeValue),
